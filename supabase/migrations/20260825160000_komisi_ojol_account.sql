-- User minta akun beban khusus buat komisi yang dipotong Gofood/Grabfood.
-- Sebelumnya pendapatan ojol (4-003/4-004) dicatat net (sudah dipotong
-- komisi platform), jadi besaran komisinya tidak pernah kelihatan di
-- pembukuan. Sekarang bisa dicatat gross + komisi dipisah ke akun beban
-- ini (5-108), biar kelihatan berapa besar komisi yang "dimakan" tiap
-- platform.
...
-- Backfill: business yang sudah ada belum punya 5-108.
do $$
declare
  v_business record;
begin
