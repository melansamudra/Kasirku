-- Hotfix KRITIS: fungsi private.build_checkout_journal_lines tidak ada di production.
-- Kembalikan ke posting jurnal inline (seperti 20260807130000_fix_checkout_rpc.sql)
-- sambil mempertahankan semua perbaikan sebelumnya:
--   - order_type (dari 20260810100000)
--   - product_recipes / pr.qty (dari 20260810110000)
--   - tanpa kondisi track_stock (dari 20260810120000)
--   - alias tp.transaction_id (dari 20260810130000, tetap dipertahankan untuk keamanan)
