-- Tambah stock_locations_enabled ke admin_list_businesses supaya superadmin
-- bisa lihat & toggle status Mode Stok (Simpel/Multi-Lokasi) per bisnis dari
-- /admin -- sebelumnya cuma bisa lewat SQL manual. Harus drop dulu karena
-- perubahan return type (pola sama dengan cost_control_enabled/
-- storefront_enabled sebelumnya).
...
begin
  ...
  select
    ...
    b.custom_domain,
    b.storefront_slug,
    coalesce(b.stock_locations_enabled, false)
