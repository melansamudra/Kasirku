-- User minta akun beban khusus buat Konsumsi (makan/minum karyawan dsb),
-- terpisah dari "Lain-lain" yang jadi tampungan umum.
...
-- Backfill: business yang sudah ada belum punya 5-107.
do $$
declare
  v_business record;
begin
