-- Laporan Harian sekarang mau misahin pendapatan Ojol per platform (Gofood
-- vs Grabfood), bukan digabung rata di 4-999 Pendapatan Lain-lain. Bikin 2
-- akun pendapatan baru; dicatat lewat "Catat Kas Masuk" di Kas & Bank
-- (pilih akun ini sebagai Sumber Dana) -- sama persis pola 4-999 yang sudah
-- ada, tidak perlu ubah kode form.
...
-- Backfill: business yang sudah ada belum punya 4-003/4-004.
do $$
declare
  v_business record;
begin
