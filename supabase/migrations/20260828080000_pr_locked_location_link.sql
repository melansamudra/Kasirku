-- Lapis 1 dari 2-lapis perbaikan akurasi lokasi pembelian: link Permintaan
-- Barang khusus per lokasi (mis. Dapur Produksi) yang lokasinya sudah
-- terkunci, staf tidak perlu/bisa pilih lokasi lain. get_purchase_request_info
-- perlu balikin is_production juga supaya halaman publik bisa cari lokasi
-- yang mau dikunci tanpa hardcode UUID/nama.
