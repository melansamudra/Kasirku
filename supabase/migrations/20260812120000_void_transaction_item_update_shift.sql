-- Tambahkan update shifts.total_sales saat item di-void setelah shift ditutup.
-- Saat shift masih buka, total_sales masih NULL — update NULL - nilai = NULL
-- (tidak berubah, aman). Saat shift sudah ditutup, total_sales sudah terisi
-- dan harus dikurangi sebesar kontribusi item yang di-void.
...
begin
  ...
  -- Update total_sales shift yang sudah ditutup agar laporan tutup shift akurat.
  -- Shift yang masih buka: total_sales masih NULL → update NULL - x = NULL (aman).
  -- Shift yang sudah tutup: kurangi total_sales sebesar nilai item yang di-void.
