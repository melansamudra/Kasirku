-- Saat checkout, simpan nama item + varian ke transaction_items.name
-- agar struk pelanggan menampilkan varian (mis. "Kopi Susu (Panas)").
-- Sebelumnya hanya v_product.name saja yang disimpan.
