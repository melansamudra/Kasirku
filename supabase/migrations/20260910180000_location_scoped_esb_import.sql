-- Lanjutan 20260910160000/170000: import_esb_sales_bulk() (tombol "Impor
-- Detail ESB", jalur harian yang dipakai Llauk) punya bug konsumsi bahan
-- baku yang sama persis dengan checkout_transaction/create_manual_transaction
-- -- cuma potong ingredients.stock global. Ini yang paling relevan ditambal
-- karena ini jalur yang benar-benar dipakai sehari-hari. Void-nya tidak
-- perlu ditambal terpisah -- transaksi hasil impor ini divoid lewat
-- void_transaction()/owner_void_transaction() yang sama (sudah ditambal),
-- cukup baris ini ikut mengisi transaction_ingredient_consumption.location_id
-- saat insert.
