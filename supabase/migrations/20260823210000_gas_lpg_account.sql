-- User minta akun beban khusus buat Gas LPG (biar tercatat rapi & bisa
-- dipantau bulanan), terpisah dari "Lain-lain" yang jadi tampungan umum.
...
-- Backfill: business yang sudah ada belum punya 5-106.
do $$
declare
  v_business record;
begin
