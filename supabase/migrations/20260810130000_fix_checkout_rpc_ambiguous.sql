-- Hotfix: perbaiki "column reference transaction_id is ambiguous" pada
-- subquery journal posting di checkout_transaction RPC.
...
begin
  ...
  -- Journal posting — gunakan variabel untuk hindari ambiguitas kolom transaction_id
  select jsonb_agg(jsonb_build_object('method', tp.method, 'amount', tp.amount))
