-- Revert dari revert sebelumnya (20260910093000) -- ternyata cascade-nya
-- memang perilaku yang diinginkan: begitu Mie Kota Pusat buka shift, Mie
-- Kota Cabang otomatis ikut kebuka (modal Rp0, owner bisa koreksi manual
-- nanti). Yang user maksud dengan "samakan dengan Adi's" adalah alur kasir
-- Pusat sendiri, bukan hubungan cascade-nya ke Cabang -- itu tetap dipakai.
