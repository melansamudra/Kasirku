-- Perbaiki checkout_transaction: kembalikan pengecekan otorisasi, validasi
-- kasir/pelanggan/self-order, posting jurnal akuntansi, dan nama produk +
-- varian label yang hilang dari migrasi 20260807120000.
-- Fitur batch dari 20260807120000 tetap dipertahankan.
...
-- Paksa PostgREST reload schema cache supaya kolom batch langsung terlihat.
