-- Bug: link scan Produksi publik selalu "halaman tidak ditemukan" untuk
-- Llauk Nusantara -- get_production_scan_info/submit_production_scan cuma
-- cek cost_control_enabled=true, padahal Llauk sejak konversi sidebar
-- standar (lihat catatan project-llauk-cost-control-locations) pakai
-- rich_stock_ops_enabled=true, cost_control_enabled sudah false. Halaman
-- dashboard /produksi sendiri sudah benar cek dua-duanya -- cuma RPC publik
-- scan ini yang kelewat, karena dibuat sebelum konversi itu terjadi.
