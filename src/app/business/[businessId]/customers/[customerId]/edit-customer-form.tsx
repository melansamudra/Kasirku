...
export default function EditCustomerForm({
  ...
  email: string | null;
  note: string | null;
  action: (state: EditCustomerState, formData: FormData) => Promise<EditCustomerState>;
}) {
  ...
  return (
    <div className="mt-2 w-full space-y-2 rounded-xl border border-zinc-200 bg-zinc-50 p-3">
      <div>
        <label className="mb-1 block text-xs font-medium text-zinc-600">Nama Pelanggan</label>
        <input
          type="text"
          value={values.name}
