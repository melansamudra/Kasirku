...
export default function AddSupplierForm({
  ...
  return (
    <form ref={formRef} action={formAction} className="space-y-3">
      ...
      <div className="grid grid-cols-2 gap-2.5">
        <div>
          <label htmlFor="bankName" className="mb-1 block text-xs font-medium text-zinc-600">
            Nama Bank (opsional)
          </label>
          <input
            id="bankName"
        ...
        <div>
          <label htmlFor="bankAccountNumber" className="mb-1 block text-xs font-medium text-zinc-600">
      ...
      <div>
        <label htmlFor="bankAccountHolder" className="mb-1 block text-xs font-medium text-zinc-600">
