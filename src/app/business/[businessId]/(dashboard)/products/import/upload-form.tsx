    ...
    if (parseState.resolutions) {
      ...
      for (const r of parseState.resolutions) {
        ...
        init[r.bahan] = {
          ...
          ingredientId: r.matchedId ?? firstCandidate?.id ?? "",
          name: r.bahan,
    ...
    <form action={runParse} className="space-y-3">
      <div>
        ...
        <p className="mt-1 text-[11px] text-zinc-400">
          ...
          <a href="/template-resep-produk" className="font-medium text-brand-600 hover:underline">
            download template di sini
          </a>
          . Produknya harus sudah ada duluan di Kelola Produk (nama harus sama persis) — import ini
          cuma mengisi/mengganti resepnya.
        </p>
      </div>
