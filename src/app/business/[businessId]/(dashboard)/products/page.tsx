...
import { addProduct, addProductCategory, importProducts } from "./actions";
...
export default async function ProductsPage({
  ...
  const { data: products } = await supabase
    .from("products")
    .select("id, name, category, price, cost, stock, min_stock, emoji, barcode, sku, variant_label, image_url, featured, department, hpp_checked")
  ...
  return (
    <div className="w-full max-w-2xl">
        ...
        <div className="mt-6">
          <ProductsListClient businessId={businessId} categoryEntries={categoryEntries} categories={categoryNames} />
        </div>
