...
export default function WarehouseRequestLinkSection({
  initialSlug,
  regenerateAction,
}: {
  initialSlug: string;
  ...
  const url = typeof window !== "undefined" ? `${window.location.origin}/permintaan-gudang/${slug}` : "";
  ...
  return (
    <div>
      ...
      <p className="mt-1.5 text-[11px] text-zinc-400">
        Bagikan link ini ke PIC Gudang Kering/Basah supaya mereka bisa mengajukan permintaan bahan
        baku ke Purchasing tanpa perlu login.
      </p>
