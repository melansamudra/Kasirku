...
const initialState: ImportTransactionsState = { error: null, result: null };
    ...
    <form ref={formRef} action={formAction} className="space-y-3">
      ...
      {state.result && !pending && (
        <div className="rounded-lg bg-brand-50 px-3 py-2 text-xs text-brand-700">
          <p>
            ✓ {state.result.created} transaksi baru dibuat
            {state.result.skipped > 0 && `, ${state.result.skipped} baris dilewati`}.
          </p>
