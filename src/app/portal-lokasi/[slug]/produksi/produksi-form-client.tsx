...
import { submitProduksiPortal, type ReportedIngredientInput } from "./actions";
...
export default function ProduksiFormClient({
  productionScanSlug,
  businessId,
  locationId,
  items,
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setPending(true);
    const res = await submitProduksiPortal(
      productionScanSlug,
      businessId,
      locationId,
    ...
    <form onSubmit={handleSubmit} className="mt-4 space-y-4">
      ...
      {mode === "existing" ? (
        ...
        <div className="space-y-3 rounded-xl border border-dashed border-zinc-300 p-3">
          <p className="text-[11px] text-zinc-500">
            Belum ada di daftar? Ketik nama bahannya — supervisor yang akan putuskan nanti digabung ke
            item lama atau dibuat item baru.
          </p>
          <div>
      ...
      <div className="rounded-xl border border-zinc-200 p-3">
        ...
        <p className="mb-2 text-[11px] text-zinc-400">
          Kalau bahan yang dipakai batch ini beda dari resep standar, catat di sini — supervisor akan
          bandingkan sebelum verifikasi.
        </p>
